...
const UserForm = () => {
  ...
  const handleCloseModal = () => setShowModal(false);  //this just sets setShowModal(false) to force the modal to close, so that's why we have
  //an arrow function here instead of a variable like the above state variables
  ...
  const handleChange = (e) => {
    ...
    setFormData({
      ...formData,  //this is destructuring the form data
      [name]: value  //this will be the value of the field (ie name, email, phone) and this tells it to update the key/value pair in the state
    });
  };
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.checkValidity() === false) {
      ...
      try {
        ...
        setSubmitted(true);
        setError(null);
        setShowModal(true);  //once submitted, this will make the modal pop up
      } catch (err) {
